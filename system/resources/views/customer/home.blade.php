...
@section('content')
      ...
      <section style="background: url('public/img/photogrid.jpg') center center repeat; background-size: cover;" class="relative-positioned">
        <!-- Carousel Start-->
            ...
            <div class="homepage owl-carousel">
              <div class="item">
                <div class="row">
                  <div class="col-md-5 text-right">
                    <p><img src="public/img/logo.png" alt="" class="ml-auto"></p>
                    <h1>Multipurpose responsive theme</h1>
                    <p>Business. Corporate. Agency.<br>Portfolio. Blog. E-commerce.</p>
                  </div>
                  <div class="col-md-7"><img src="public/img/template-homepage.png" alt="" class="img-fluid"></div>
                </div>
              </div>
              <div class="item">
                <div class="row">
                  <div class="col-md-7 text-center"><img src="public/img/template-mac.png" alt="" class="img-fluid"></div>
                  <div class="col-md-5">
              ...
              <div class="item">
                <div class="row">
                  ...
                  <div class="col-md-7"><img src="public/img/template-easy-customize.png" alt="" class="img-fluid"></div>
                </div>
              </div>
              <div class="item">
                <div class="row">
                  <div class="col-md-7"><img src="public/img/template-easy-code.png" alt="" class="img-fluid"></div>
                  <div class="col-md-5">
